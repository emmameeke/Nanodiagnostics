document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("scroll", function () {
      ...
      // Video Transition Logic for MRI
      ...
      const nanoporeTransition1 = sectionNanoporeTop + sectionNanoporeHeight * 0.5;

      nanoporeVideos.forEach(video => video.style.opacity = "0"); // Hide all videos by default
